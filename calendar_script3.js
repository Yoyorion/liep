...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const supabaseUrl = 'https://okyvtousjpxqoqlphhfm.supabase.co';  // URL Supabase
    const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9reXZ0b3VzanB4cW9xbHBoaGZtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjY4NDc5NTYsImV4cCI6MjA0MjQyMzk1Nn0.-trScKtevO_HxaifhRsQg5uzBxzYV9pJ5Hz6EvqOVzk';  // Anon public key
    const supabase = window.supabase.createClient(supabaseUrl, supabaseKey);  // Initialiser Supabase avec les informations correctes
